import { Stat, stats } from "../../Home/About/Stats";

const OurStory = () => {
  return (
    <section className="px-6 py-20 bg-white flex flex-col items-center font-poppins">
      <div className="flex flex-col gap-10 lg:gap-0 lg:flex-row lg:w-11/12 xl:w-10/12 lg:justify-between">
        <header className="flex flex-col gap-4  ">
          ...
          <h6 className="text-darkblue font-semibold text-lg lg:text-base">
            Our story👇
          </h6>
...
const Logos = () => {
  return (
    <div className="grid grid-cols-2 w-full mt-20 gap-3  lg:grid-cols-3 bg-skyblue xl:grid-cols-5 lg:w-10/12">
