const Intro = () => {
  return (
    <section className="py-12 px-6 flex flex-col items-center font-poppins md:px-20 lg:px-6">
      <div className=" relative flex items-start justify-between lg:w-11/12 xl:w-10/12">
        <header className="flex flex-col gap-3">
          ...
          <p className="text-darkblue text-sm font-light md:text-base lg:text-sm lg:w-6/12">
